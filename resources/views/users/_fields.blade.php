...
<div class="form-group">
    ...
    <textarea class="form-control" name="bio" id="id">{{ old('bio', $user->profile->bio) }}</textarea>
</div>

<div class="form-group">
    <lable for="profession_id">Profesión</lable>
    <select name="profession_id" id="profession_id" class="form-control">
        <option value="">Seleccionar una profesión</option>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="twitter" id="twitter"
           placeholder="https://twitter.com/Stydenet" value="{{ old('twitter', $user->profile->twitter) }}">
</div>

    ...
    <div class="row row-filters">
        ...
        <div class="col-md-6 text-right">
            <div class="form-inline form-dates">
                ...
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" name="from" id="from" value="{{ request('from') }}" placeholder="Desde">
                </div>
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" name="to" id="to" value="{{ request('to') }}" placeholder="Hasta">
                </div>
                &nbsp;
